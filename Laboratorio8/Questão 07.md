...
7 - Faça um programa para excluir os alunos que foram reprovados, sabendo que serão
...
int main()
{
    ...
    for (int i = 0; i < n; i++)
    {
        ...
        {
            printf("Aluno %s reprovado (média %.2f), sera excluido.\n", a[i].nome,
                   media);
        }
    }
    ...
    fclose(f);
    printf("Dados salvos com sucesso! Total de aprovados: %d\n", n_aprovados);
    return 0;
}